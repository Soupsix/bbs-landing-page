...
const CONTENT = {
  vi: {
    header: "Bạn đang gặp khó khăn trong truyền thông?",
    subHeader: "Những vấn đề doanh nghiệp thường xuyên đối mặt khi tự triển khai hoặc thuê ngoài không hiệu quả.",
    points: [
      {
  ...
  en: {
    header: "Struggling with media and communications?",
    subHeader: "Common problems businesses face when self-implementing or outsourcing ineffectively.",
    points: [
      {
        title: "Ineffective Media Content",
        description: "Investing heavy budgets but videos get no views and generate no conversions.",
        icon: TrendingDown
      },
      {
        title: "Lack of Creative Ideas",
        description: "Repetitive, boring content that fails to attract the target audience.",
        icon: LayoutTemplate
      },
      {
        title: "Slow Execution, High Costs",
        description: "Working with multiple agencies makes the process complex and incurs extra costs.",
        icon: Clock
      },
      {
        title: "Lackluster Events",
        description: "Events are organized but fail to leave a strong impression on guests and partners.",
        icon: AlertCircle
      }
    ]
  }
